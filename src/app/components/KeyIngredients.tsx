...
const ingredientsData: IngredientCardProps[] = [
  {
    ...
    description:
      "Enhances nutrient absorption and digestion, supporting weight management and metabolic function.",
  ...
  },
  {
    ...
    description:
      "Aids digestion and metabolism, promoting weight management by increasing calorie burning.",
  ...
  },
  {
    ...
    description:
      "Elevates energy levels and focus, facilitating fat burning and alertness.",
  ...
  },
  {
    ...
    description:
      "Boosts metabolism and offers a rich source of antioxidants, supporting fat oxidation.",
  ...
  },
  {
    ...
    description:
      "Enhances mental clarity and concentration, aiding in fatty acid transportation for energy.",
  ...
  },
  {
    title: "Guggul",
    description:
      "Supports healthy cholesterol levels and stimulates thyroid function to boost metabolism.",
  ...
  },
  {
    ...
    description:
      "Aids in weight management by inhibiting fat storage and suppressing appetite.",
    imageUrl: "/assets/images/img12.jpg",
  ...
  },
  {
    title: "Capsimax",
    description:
      "Supports metabolism and thermogenesis, promoting weight management by increasing calorie burning and fat oxidation",
    imageUrl: "/assets/images/img12.jpg",
  ...
  return (
    <section className="w-full min-h-screen flex flex-col items-center justify-center font-sans bg-blue-200 gap-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-10 rounded-md">
        {ingredientsData
          .slice(0, isExpanded ? ingredientsData.length : 6)
          .map((ingredient, index) => (
            ...
            >
              ...
              <p className="mt-4 text-lg w-[300px] text-gray-700">
        ...
        <div className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-lg w-1/3">
            <h2 className="font-bold text-2xl">
              {selectedIngredientDetails.title}
            </h2>
            <Image
              src={selectedIngredientDetails.imageUrl}
              alt={selectedIngredientDetails.title}
              width={100}
              height={100}
              className="rounded-md"
            />
            ...
            <div className="mt-4 text-lg">
              <p>
                ...
                {selectedIngredientDetails.nutritionalFacts}
              </p>
              <p>
                <strong>Chemistry Name:</strong>{" "}
                {selectedIngredientDetails.chemistryName}
              </p>
              <p>
                <strong>Origin:</strong> {selectedIngredientDetails.origin}
              </p>
            </div>
            <button
