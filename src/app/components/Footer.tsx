...
const Footer = () => {
  return (
 <footer className='w-full min-h-[80vh] flex flex-col bg-black text-white items-center justify-center gap-20'>
     <div className='flex items-center gap-32 justify-center'>
      <div className='flex flex-col w-[300px] gap-5 '>
        <Image src="/assets/images/footer-logo.avif" alt='logo' width={300} height={400}/>
        <p>Discover the power of Ayurveda to support diabetes management, promote healthy weight, and enhance heart wellness. At Goodveda, we offer natural supplements designed to aid in managing chronic conditions and support your journey toward a healthier lifestyle.</p>
        <div className='flex items-center w-[500px] gap-5 text-2xl'>
          <FaFacebook />
          <FaInstagram />
          <IoLogoYoutube />
        </div>
      ...
      <ul className='flex flex-col w-[200px] list-none gap-8 text-xl'>
      ...
      <ul className='flex flex-col w-[200px] list-none gap-8 text-xl'>
        ...
        <li className="hover:text-gray-400">India Office:  Suit 106, H-32, Sector 63, Noida, (U.P) 201301</li>
        <li className="hover:text-gray-400">US Office:  447 Broadway, 2nd Floor Suite #1445, New York, 10013, USA</li>
      </ul>
    </div>
    <p className='text-xl text-gray-600'>All rights reserved © Goodveda  2024</p>
 </footer>
  )
}
